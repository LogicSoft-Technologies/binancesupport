        ...
        <table class="email-wrapper" role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td class="email-header" align="center"
              style="background-color:#0b0e11;padding:36px 40px 32px 40px;">
                  ...
                  <td align="center">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="center">
                          <div style="width:14px;height:14px;background-color:#FCD535;transform:rotate(45deg);display:inline-block;margin-bottom:-8px;"></div>
                        </td>
                        <td style="width:8px;"></td>
                      </tr>
                      <tr>
                        <td align="center">
                          <div style="width:14px;height:14px;background-color:#FCD535;transform:rotate(45deg);display:inline-block;"></div>
                        </td>
                      ...
                      <tr>
                        <td style="width:8px;"></td>
                        <td align="center">
                          <div style="width:22px;height:22px;background-color:#FCD535;transform:rotate(45deg);display:inline-block;margin-top:-8px;"></div>
                        </td>
                        <td style="width:8px;"></td>
                      </tr>
                    </table>
              ...
              <p style="margin:0;font-family:'Arial Black','Helvetica Neue',Arial,sans-serif;
                font-size:26px;font-weight:900;letter-spacing:3px;color:#FCD535;line-height:1;">
                BINANCE
              </p>
              <p style="margin:6px 0 0 0;font-size:11px;font-weight:500;letter-spacing:2px;
          ...
          <!-- Yellow accent line -->
          <tr>
            <td style="background-color:#FCD535;height:3px;font-size:0;line-height:0;">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td class="email-content" style="padding:48px 40px 40px 40px;background-color:#ffffff;">
              ...
              <p style="margin:0 0 8px 0;font-size:13px;font-weight:600;letter-spacing:1.5px;
                text-transform:uppercase;color:#848e9c;">
                Message from Support
              </p>
              <h1 class="h1" style="margin:0 0 28px 0;font-size:26px;font-weight:700;
                line-height:34px;color:#1e2329;letter-spacing:-0.3px;">
                ${subject}
              </h1>

              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="height:1px;background-color:#eaecef;font-size:0;line-height:0;padding-bottom:28px;">&nbsp;</td>
                </tr>
              </table>

              <div class="message-box" style="background-color:#fafafa;border:1px solid #eaecef;
                border-radius:4px;padding:28px;margin-bottom:28px;">
                <p style="margin:0;font-size:15px;line-height:26px;color:#474d57;
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background-color:#FCD535;border-radius:4px;">
                    <a href="mailto:${process.env.EMAIL_REPLY_TO}"
                      style="display:inline-block;padding:14px 28px;font-size:14px;
                      font-weight:700;color:#1e2329;letter-spacing:0.3px;text-decoration:none;">
              ...
              <div style="background-color:#fffdf0;border:1px solid #f0d080;
                border-left:4px solid #FCD535;border-radius:4px;padding:16px 20px;">
                <p style="margin:0 0 4px 0;font-size:12px;font-weight:700;color:#b7791f;
                  text-transform:uppercase;letter-spacing:0.8px;">
                  🔒 Security Notice
                </p>
                <p style="margin:0;font-size:12.5px;line-height:20px;color:#92400e;">
                  Binance will never ask for your password, private keys, or seed phrase.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td class="email-footer" align="center" style="padding:0 40px 32px 40px;">
                    <p style="margin:0 0 6px 0;font-size:12px;color:#b7bdc6;line-height:20px;">
                      © ${year} Binance Support. All rights reserved.
                    </p>
                    <p style="margin:0 0 6px 0;font-size:12px;color:#b7bdc6;line-height:20px;">
                      You received this email because you have an active inquiry with Binance Support.
                    </p>
                    <p style="margin:0;font-size:12px;color:#b7bdc6;line-height:20px;">
                      Reply to: <a href="mailto:${process.env.EMAIL_REPLY_TO}"
                        style="color:#848e9c;text-decoration:underline;">${process.env.EMAIL_REPLY_TO}</a>
                    </p>
                  </td>
                </tr>
              </table>
...
`;
  ...
  try {
    await transporter.sendMail({
      from: `"Binance Support" <${process.env.EMAIL_FROM}>`,
      to,
      subject,
